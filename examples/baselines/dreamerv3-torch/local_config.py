...
class LocalArgs:
    ...
    wm_directory: str = "/home/wmcbf/ManiSkill/examples/baselines/dreamerv3-torch/wm_cbf_checkpoint/wm_lz_sept4.pt"
    filter_directory_nogp: str = '/home/wmcbf/ManiSkill/examples/baselines/dreamerv3-torch/wm_cbf_checkpoint/no_gp_aug6.pth'
    filter_directory_gp: str = '/home/wmcbf/ManiSkill/examples/baselines/dreamerv3-torch/wm_cbf_checkpoint/gp_sept4.pth'
    offline_data_path: str = '/home/kensuke/ManiSkill/examples/baselines/ppo/runs/BlockTopple-v0__ppo_rgb__1__1753308792/test_videos/trajectory.rgb.pd_ee_delta_pose.physx_cuda.h5'
